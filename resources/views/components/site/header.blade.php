<header
    ...
    class="sticky top-0 z-50 border-b border-stone-200/80 bg-white/95 backdrop-blur">
    ...
    <div
        ...
        <nav
            ...
            <div class="flex flex-col">
                ...
                <a
                    href="{{ route('home') }}"
                    @class([ 'rounded-lg px-3 py-3 text-sm font-medium transition' , 'bg-primary-50 text-primary-900'=> request()->routeIs('home'),
                    'text-stone-700 hover:bg-stone-50 hover:text-primary-900' => !request()->routeIs('home'),
                    ])>
                    Accueil
                </a>
                ...
                <a
                    href="{{ route('posts.index') }}"
                    @class([ 'rounded-lg px-3 py-3 text-sm font-medium transition' , 'bg-primary-50 text-primary-900'=> request()->routeIs('posts.*'),
                    'text-stone-700 hover:bg-stone-50 hover:text-primary-900' => !request()->routeIs('posts.*'),
                    ])>
                    Actualités
                </a>
                ...
                <a
                    href="{{ route('documents.index') }}"
                    @class([ 'rounded-lg px-3 py-3 text-sm font-medium transition' , 'bg-primary-50 text-primary-900'=> request()->routeIs('documents.*'),
                    'text-stone-700 hover:bg-stone-50 hover:text-primary-900' => !request()->routeIs('documents.*'),
                    ])>
                    Documents
                </a>
                ...
                <a
                    href="{{ route('contact') }}"
                    @class([ 'rounded-lg px-3 py-3 text-sm font-medium transition' , 'bg-primary-50 text-primary-900'=> request()->routeIs('contact'),
                    'text-stone-700 hover:bg-stone-50 hover:text-primary-900' => !request()->routeIs('contact'),
                    ])>
                    Nous contacter
                </a>
